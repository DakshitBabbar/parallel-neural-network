...
FANN_EXTERNAL fann_type *FANN_API fann_run(struct fann *ann, fann_type *input) {
  ...
  struct fann_neuron *ann_first_neuron = ann->first_layer->first_neuron;
...
//==============================================================================//
    ...
    //============//
    struct fann_neuron *my_neurons, *neuron_connections, *last_neuron_connection;
    unsigned int num_neurons, num_neuron_connections, num_weights;

    my_neurons = layer_it->first_neuron;
    num_neurons = last_neuron - layer_it->first_neuron;

    neuron_connections = (layer_it-1)->first_neuron;
    last_neuron_connection = (layer_it - 1)->last_neuron;
    num_neuron_connections = last_neuron_connection - (layer_it-1)->first_neuron;

    weights = ann->weights + layer_it->first_neuron->first_con;
    num_weights = (num_neurons-1)*num_neuron_connections;
    //============//

    //printf("working at layer=%d, with num_neurons=%u, num_neuron_connections=%u and num_weights=%u\n", l, num_neurons, num_neuron_connections, num_weights);
    
    //=====================trial2===================//
    //compute_entire_layer(my_neurons, num_neurons, neuron_connections, num_neuron_connections, weights, num_weights);
    //=============================================//

    //====================trial3===================//
    direct_compute_entire_layer(my_neurons, num_neurons, neuron_connections, num_neuron_connections, weights, num_weights);
    //============================================//
    l++;
...
// //=============================================================================//        
// /**/
//         neuron_sum = compute_neuron_sum(weights, neurons, num_connections);
// /**/
// //=============================================================================//
//         /* same as modulo 4 */
// /*        i = num_connections & 3; 
